...
│   │   ├── admin.go              # GetTitleIssues、FixSingleTitle（同時修個握+購入+寫 title_corrections）、GetAdminUsers、DeleteUserRecords、DeleteUserFullRecords
...
│   │       ├── FullView.vue          # 全握統計頁（總覽、依類型/場地、依成員、依單曲）※路由已改 redirect 至 /dashboard
